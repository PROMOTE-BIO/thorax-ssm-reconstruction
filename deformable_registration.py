...
import numpy as np
import numbers
from em_registration import EMRegistration
...
class DeformableRegistration(EMRegistration):
    ...
    def __init__(self, alpha=None, beta=None, *args, **kwargs):
        ...
        # The original alpha and beta parameters were valued 2.
        # New values were 2e4 and 2e-4
        self.alpha = 3 if alpha is None else alpha # This is lambda from the original algorithm of Myronenko
        self.beta = 1 if beta is None else beta # This is beta from the original algorithm of Myronenko
